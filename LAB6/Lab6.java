...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
        ...
        gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,GL2.GL_AMBIENT, FloatBuffer.wrap(ambient));
        gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,GL2.GL_DIFFUSE, FloatBuffer.wrap(diffuse));
        gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,GL2.GL_SPECULAR, FloatBuffer.wrap(specular));
        gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, FloatBuffer.wrap(shininess));
